...
- [Exploring Germany's Urban Geography with Census and OpenStreetMap Data (YouTube)][youtube-exploring-germanys]
...
At the end of last year, I began working on a tool for importing German Census Data into PostgreSQL called [zensus2pgsql][zensus2pgsql]. This was a fun project I created in my free time, and my first use of it was pairing census data with OpenStreetMap data to ask random questions like [how many REWEs Germany has][how-many-rewes]. This superficial data exploration left me wanting to embark on a little more ambitious project, and this is how the idea of conducting a spatial accessibility analysis for the entire country of Germany came to mind.

I did something similar my master thesis, but I only focused on the city of Kiel. After completing that project, I always wanted to go even further and conduct an analysis of an entire country. Unfortunately, I never had enough time to devote to this after beginning my full-time job. But, at the beginning of this year, I reduced my working hours from 40 to 32 (five to four days a week) to make room for these types of projects. This extra day a week gave me just enough breathing room to make approaching a project like this possible without completely burning out.

So, with enough time to dedicate to this project, I decided to submit my [talk proposal][proposal], and once it got accepted, I got to work.
...
Seeing all of these little tools come together like this to create powerful applications for analysis is really neat. I often ask myself whether I prefer doing the analysis or creating the tools themselves more while working on these projects. The answer is both! I come up with a question I want to answer. I write the tools to do the analysis and answer this question. I realize I need more tools to answer more questions and then work on those. A never-ending cycle.
...
[pg-helper]: https://github.com/travishathaway/pg-helper/
[gis-forge]: https://anaconda.org/gis-forge
[conda-forge]: https://conda-forge.org/
[german-census]: https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Bevoelkerung/Zensus2022/_publikationen.html
[osm]: https://openstreetmap.org/
[proposal]: https://2026.pycon.de/talks/WQGXJ3/